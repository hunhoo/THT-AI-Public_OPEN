 ...
 * @author Tian
 */
public class Kangker_Leher_Metastatik extends javax.swing.JFrame {

    /**
     * Creates new form Kangker_Leher_Metastatik
     */
    public Kangker_Leher_Metastatik() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea4.setText("Dilakukan terapi penyinaran dan di lakukan kemoterapi dengan di berikan obat cisplatin dan cetuximab.");
        jScrollPane4.setViewportView(jTextArea4);

        jTextArea1.setColumns(20);
        jTextArea1.setLineWrap(true);
        jTextArea1.setRows(5);
        jTextArea1.setText("Kanker Leher Metastatik adalah kanker leher yang terjadi sebagai akibat dari penyebaran kanker di bagian tubuh lainnya.\n");
        ...
        jTextArea3.setText("Jika sel-sel kanker ditemukan di dalam kelenjar getah bening leher yang membesar dan sumber kankernya tidak dapat ditemukan, maka dilakukan terapi penyinaran terhadap faring, tonsil, dasar lidah dan kedua sisi leher.\nSelain itu, dilakukan pengangkatan kelenjar getah bening dan jaringan lainnya yang terkena.");
        ...
        jLabel3.setText("Penyakit Kangker Leher Metastatik");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pakar/Penakit THT/kangker leher metastatik.png"))); // NOI18N
...
dispose();  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kangker_Leher_Metastatik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
