 ...
 * @author Tian
 */
public class Kangker_Tonsil extends javax.swing.JFrame {

    /**
     * Creates new form Kangker_Tonsil
     */
    public Kangker_Tonsil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea2.setText("Penyebab\nKanker tonsil terutama menyerang pria dan berhubungan erat dengan merokok serta pemakaian alkohol.\n\nGejala\nBiasanya gejala awal adalah nyeri tenggorokan.\nNyeri seringkali menjalar ke telinga pada sisi yang sama dengan tonsil yang terkena. Kadang suatu benjolan di leher akibat penyebaran kanker ke kelenjar getah bening timbul sebelum gejala lainnya muncul.");
        jScrollPane2.setViewportView(jTextArea2);

        jTextArea3.setColumns(20);
        jTextArea3.setLineWrap(true);
        jTextArea3.setRows(5);
        jTextArea3.setText("Pengobatannya beruba terapi penyinaran dan pembedahan. Pembedahan dilakukan untuk mengangkat tumor, kelenjar getah bening leher dan sebagian rahang.");
        ...
        jTextArea4.setText("Metode Terapi Kristal Untuk Kanker Tonsil (Amandel)");
        jScrollPane4.setViewportView(jTextArea4);

        jTextArea1.setColumns(20);
        jTextArea1.setLineWrap(true);
        jTextArea1.setRows(5);
        jTextArea1.setText("Kanker Tonsil adalah keganasan pada tonsil (amandel).");
        ...
        jLabel3.setText("Penyakit Kangker Tonsil");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pakar/Penakit THT/kangker tonsil.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kangker_Tonsil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
