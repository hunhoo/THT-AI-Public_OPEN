 ...
 * @author Tian
 */
public class Tumor_Syaraf_Pendengaran extends javax.swing.JFrame {

    /**
     * Creates new form Tumor_Syaraf_Pendengaran
     */
    public Tumor_Syaraf_Pendengaran() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Tumor Saraf Pendengaran (Neroma Akustik, Neurinoma Akustik, Schwannoma Vestibuler, Tumor Saraf VIII) adalah suatu tumor jinak yang berasal dari sel Schwann (sel yang membungkus saraf).");
        jScrollPane1.setViewportView(jTextArea1);

        jTextArea3.setColumns(20);
        jTextArea3.setLineWrap(true);
        jTextArea3.setRows(5);
        jTextArea3.setText("Untuk menghindari kerusakan pada saraf wajah, tumor yang kecil diangkat melalui pembedahan mikro.\nTumor yang lebih besar diangkat melalui pembedahan yang lebih luas.");
        ...
        jLabel3.setText("Penyakit Tumor Syaraf Pendengaran");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Pakar/Penakit THT/tumor syara pedengaran.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tumor_Syaraf_Pendengaran.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
